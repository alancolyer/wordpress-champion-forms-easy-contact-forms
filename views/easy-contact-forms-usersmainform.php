...
?>
  <div>
    <?php EasyContactFormsLayout::getTabHeader(array('GeneralInfo', 'ContactInfo', 'More', 'History'), 'top');?>
      ...
      <div id='GeneralInfo' class='ufo-tabs ufo-tab ufo-active'>
        <div>
          ...
          <div class='ufo-float-right ufo-width50'>
            <div>
              <label><?php echo EasyContactFormsT::get('FirstName');?></label>
      ...
      <div id='ContactInfo' class='ufo-tabs ufo-tab'>
        <div class='ufo-float-left ufo-width50'>
          <div>
            ...
            <input type='hidden' value='ufo.setupCalendar("Birthday", {ifFormat:"<?php echo EasyContactFormsT::get('DateFormatCalendar');?>", firstDay:0, align:"Bl", singleClick:true});' class='ufo-eval'>
          </div>
          <div>
            <label><?php echo EasyContactFormsT::get('Country');?></label>
          ...
          <div>
            <label><?php echo EasyContactFormsT::get('City');?></label>
          ...
          <div>
            <label><?php echo EasyContactFormsT::get('State');?></label>
          ...
          <div>
            <label><?php echo EasyContactFormsT::get('Zip');?></label>
        ...
        <div class='ufo-float-right ufo-width50'>
          ...
          <div>
            <label><?php echo EasyContactFormsT::get('email2');?></label>
          ...
          <div>
            ...
            <input type='hidden' value='var c = {};c.id = "Cell";c.events = {};c.events.blur = [];c.minmax={};c.minmax.msg=AppMan.resources.ValueLengthShouldBeLessThan;c.minmax.args=[];c.minmax.args.push("30");c.max="30";c.events.blur.push("minmax");c.invClass = "ufo-fields-invalid-field";AppMan.addValidation(c);' class='ufo-eval'>
          ...
          <div>
            ...
            <input type='hidden' value='var c = {};c.id = "Phone1";c.events = {};c.events.blur = [];c.minmax={};c.minmax.msg=AppMan.resources.ValueLengthShouldBeLessThan;c.minmax.args=[];c.minmax.args.push("30");c.max="30";c.events.blur.push("minmax");c.invClass = "ufo-fields-invalid-field";AppMan.addValidation(c);' class='ufo-eval'>
            <div id='Phone1-invalid' class='ufo-fields-invalid-value ufo-id-link' style='position:absolute;display:none'></div>
          </div>
          <div>
            <label><?php echo EasyContactFormsT::get('Phone2');?></label>
            <input type='text' id='Phone2' value='<?php echo $obj->get('Phone2');?>' class='textinput ufo-text ufo-formvalue' style='width:100%'>
            <input type='hidden' value='var c = {};c.id = "Phone2";c.events = {};c.events.blur = [];c.minmax={};c.minmax.msg=AppMan.resources.ValueLengthShouldBeLessThan;c.minmax.args=[];c.minmax.args.push("30");c.max="30";c.events.blur.push("minmax");c.invClass = "ufo-fields-invalid-field";AppMan.addValidation(c);' class='ufo-eval'>
            <div id='Phone2-invalid' class='ufo-fields-invalid-value ufo-id-link' style='position:absolute;display:none'></div>
          </div>
          <div>
            <label><?php echo EasyContactFormsT::get('Phone3');?></label>
            <input type='text' id='Phone3' value='<?php echo $obj->get('Phone3');?>' class='textinput ufo-text ufo-formvalue' style='width:100%'>
            <input type='hidden' value='var c = {};c.id = "Phone3";c.events = {};c.events.blur = [];c.minmax={};c.minmax.msg=AppMan.resources.ValueLengthShouldBeLessThan;c.minmax.args=[];c.minmax.args.push("30");c.max="30";c.events.blur.push("minmax");c.invClass = "ufo-fields-invalid-field";AppMan.addValidation(c);' class='ufo-eval'>
            <div id='Phone3-invalid' class='ufo-fields-invalid-value ufo-id-link' style='position:absolute;display:none'></div>
          </div>
          <div>
            <label><?php echo EasyContactFormsT::get('SkypeId');?></label>
          ...
          <div>
            <label><?php echo EasyContactFormsT::get('Website');?></label>
